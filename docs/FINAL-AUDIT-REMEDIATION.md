...
> - **What's LEFT:** C3 (money-provability — needs PG + focus); L2–L6 (Low polish); M2 (verify), M8 (doc); Stage 12 CI (H9) + Sentry (H6); C5 nonce table. Ali/infra: H2 Redis, H8 object storage, H6 DSN, TRA ruling, MNO logos, pentest.
...
| 8 | Ledger provability & audit chain | C3, C6 | `[~]` (C6 ✓ · C3 open) |
