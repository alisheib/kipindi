...
## ▶ 0 · MOBILE VISUAL PLAN — `MOBILE-VISUAL` · 🟠 **APPROVED 2026-09-15 (v3) · START HERE** · 10/42 units ✅ · 5/83 defects ✅ (D28 · D49 · D33 · D51 · D56) · 🔵 shipped early and live: D57 · D63 · D65 · D30 · D7 · **D71–D81** (`371690b6` + follow-up 2026-09-24 — /live's hero resized on a timer for 0.0796 un-input CLS, and three skeletons promised the wrong page) · **D36 + D37** (`a7da5f89` 2026-09-24 — the board priced a settled round at today's quote, and the history strip's money moved when you turned the page; U35 still needs D45 and D52) · ◐ half: D31 · D35 · D54 · D30 and D7 shipped early and live (🔵 `a25c127b`) · D31 HALF closed — the mask overflow only
