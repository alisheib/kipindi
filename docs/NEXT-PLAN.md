...
## ▶ 0a · MARKETING CAMPAIGN & CONTACTS SETUP — `MARKETING-CAMPAIGN-AND-CONTACTS-SETUP` · 🟢 **BUILDING — S1–S7 done 2026-09-26; U1–U12 are live** · 12/52 units ✅ · 11/25 defects ✅ · 🔴 U9's premise failed (there was no send loop — it is U43's), so it shipped the loop's dispatch step and the contract U43 must pass; U10 found U7's "deciding must not write" fix was half a fix, and that a one-hour break had been refusing marketing for ever under the wrong reason
