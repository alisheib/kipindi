...
| **Next** | ⛔ Read it from the plan's §0 ▶ NEXT, which is the only authority — this cell said "Session S1 → U1 and U2" for five sessions after S1 had shipped (corrected 2026-09-25). At that date: **S6 → U9 and U10**. Two units per session |
