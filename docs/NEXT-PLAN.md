...
| **Next** | ⛔ Read it from the plan's §0 ▶ NEXT, which is the only authority — this cell said "Session S1 → U1 and U2" for five sessions after S1 had shipped (corrected 2026-09-25). At S6's close (2026-09-25): **S7 → first repair what U6's migration dropped on production (the eight trigram search indexes, plus a guard — plan §0 🔴; nothing is broken now), then U11 (18+) and U12 (the published promise — ends at Ali's OQ6 ruling)**. Two units per session |
