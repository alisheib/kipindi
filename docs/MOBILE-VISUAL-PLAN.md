...
| D32 | ◐ calm branch + region name + duplicate (`230ac116`, `9d2da8ee`, live); the phone PAUSE control is still U33's | U33 |
| D33 | ✅ `de2e9643` 2026-09-23 | U6 |
| D34 | ⬜ | U9 |
| D35 | ◐ HALF — the large-text half (`c21a2f37`); the cold-start case at 320 native is untested  ◐ **HALF FIXED — `c21a2f37`, and the half NOT fixed is the half this line describes.** The LARGE-TEXT case is closed: `.mcardp-meta` wraps below 300px, so 12 of 15 cards clipped at an effective 277 and 13 of 15 at 246 are now 0, live. ⭐ A discriminator names the cause: `.mcardp-timeleft` is 148px at 320, 277 AND 246 — identical — because `.mcardp-meta-right` is `flex-shrink: 0`; the row never ran out of space, it spent it on the clock and charged the money. ⛔ **The COLD-START case at 320 native — what this row was written about — is NOT fixed and NOT verified:** the 300px gate deliberately excludes 320, and no cold-start card was on the board to measure. Do not read the green guard as covering it. Verified on production by `npm run qa:focus-and-fit` (4 RED controls, each required to break its OWN section).| U32 |
| D36 | ⬜ | U35 |
| D37 | ⬜ | U35 |
| D38 | ⬜ | U36 |
| D39 | ⬜ | U37 |
...
| D75 | ⬜ open — measured by session asheib-b1 on the landing hero, handed over 2026-09-24 | U7 |
...
- ⬜ **D75 — the chat FAB covers the landing hero's price at rest, above the fold.** `.cm-fab` is 44×44 at (300, 656) at 360 and overlaps 32% of the first hero question's "29% NDIO" block.
