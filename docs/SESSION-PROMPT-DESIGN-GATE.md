...
| **5** | ⛔ **THE FINAL STAGE, AND A SESSION OF ITS OWN — DO NOT START IT UNTIL 1–4 CLOSE.** Admin shape & forms: tabs for the long consoles · unsaved-changes detection · validation that is complete AND takes you to the offending field | **DG-S-01…06** — see *"STEP 5"* below |
