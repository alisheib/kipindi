...
| `MEASUREMENT-PLAN.md` | What is instrumented, and **kill criteria agreed in advance**. Read before launch. |
| `COMPLIANCE-MEMO.md` | Draft responsible-play memo for compliance. **Not approved** — needs their sign-off. |
