...
> **Put this in the repo** as `docs/design-system/v2-2026-07-27/06-patterns-and-rules/
> MERGE-DISCIPLINE.md`, and add a one-line pointer to it from `DESIGN_AUTHORITY.md`
> (as invariant **B9**) and from `RULES.md` (as **law 15**). It is written in the
> same "rule → reason → broken looks like" voice as your existing laws.
>
