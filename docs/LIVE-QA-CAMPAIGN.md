...
| _(this one)_ | 🟠 **E-70 REPRODUCED AND FIXED** — Ali's lost navbar. A **layout** bug, not a session bug, and it explains session 21's observation too | new `test:shell-boundary` **9**, `red:shell-boundary` **5/5** |
