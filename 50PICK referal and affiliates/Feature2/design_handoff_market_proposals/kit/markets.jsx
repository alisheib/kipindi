...
const MarketCard = ({ title, titleSw, category, yesPct, volume, predictors, timeLeft, status = 'live', resolved, hover }) => (
  <div
    style={{
      ...
      border: `1px solid ${hover ? 'var(--indigo-500)' : 'var(--border)'}`,
...
const ResolutionPanel = ({ resolved }) => (
  <div style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 12, background: 'var(--bg-overlay)', borderRadius: 'var(--r-md)', marginBottom: 12 }}>
      ...
      <button style={{ marginLeft: 'auto', background: 'transparent', border: 'none', color: 'var(--indigo-300)', cursor: 'pointer', fontSize: 12, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
...
const EmptyMarketsArt = () => (
  <svg width="120" height="80" viewBox="0 0 120 80" fill="none" stroke="var(--indigo-400)" strokeWidth="1.5">
