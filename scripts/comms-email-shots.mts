...
const PAGES: { name: string; html: string }[] = [
  ...
  { name: "houseBotAdminHtml.paused", html: E.houseBotAdminHtml({
    ...
    cta: { href: "https://www.50pick.tz/admin/house-bots/hb_a1b2c3d4e5f6a7b8c9d0e1f2?reverify=1", label: "Enter new password" },
  }) },
  { name: "houseBotAdminHtml.switch", html: E.houseBotAdminHtml({
    ...
    cta: { href: "https://www.50pick.tz/admin/house-bots", label: "Open house bots" },
  }) },
  ...
  { name: "houseBotAdminHtml.alert", html: E.houseBotAdminHtml({
    ...
    cta: { href: "https://www.50pick.tz/admin/house-bots/hb_a1b2c3d4e5f6a7b8c9d0e1f2?tab=money", label: "Open in the console" },
  }) },
