...
const MUTATIONS = [
     ...
     narrowed back to the surface that was already safe. */
  {
    ...
    file: DICT,
    from: `A public objection window of {hours} opens after resolution, and no money moves until it closes.`,
  ...
  },
  {
    ...
    file: DICT,
    from: `Dirisha la pingamizi la {hours} linafunguliwa baada ya utatuzi, na hakuna fedha inayohamishwa hadi lifungwe.`,
