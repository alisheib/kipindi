...
import { MUTATIONS } from "./anchors/chain-purge.anchors.mjs";
...
const GATE = "scripts/chain-purge.test.mts";
...
const base = runGate();
if (base.code !== 0) {
  console.error("REFUSING: test:chain-purge is already RED on the untouched tree.");
