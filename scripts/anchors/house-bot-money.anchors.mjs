...
export const MUTATIONS = [
  ...
  },
  {
    ...
    to: `      houseOnly: false,`,
    expect: "8.9 · the house-only holder's verdict notice has the label and NO objection invitation",
    suite: "money-mem",
  },
  {
    ...
    expect: "8.10 · the mixed holder keeps the invitation",
    suite: "money-mem",
  },
  {
    name: "UX-2 · the house selection-closed notice loses its title label",
    file: "src/lib/server/notification-service.ts",
    from: "const titlePrefix = (lang: keyof typeof LIQUIDITY_LINE) => (opts.houseStake ? `${LIQUIDITY_LINE[lang].slice(3)} · ` : \"\");",
    to: "const titlePrefix = (lang: keyof typeof LIQUIDITY_LINE) => (lang ? \"\" : \"\");",
    expect: "8.7 · the labelled selection-closed notice carries the label in its title",
    suite: "money-mem",
  },
  {
    name: "UX-2 · the house selection-closed notice shares the personal notice's push tag",
    file: "src/lib/server/notification-service.ts",
    from: "}, opts.houseStake ? { pushTag: `selection-closed-house:${opts.marketId}` } : undefined);",
    to: "}, undefined);",
    expect: "6.h1 · notifySelectionClosed passes pushTag selection-closed-house:<marketId> exactly when houseStake",
    suite: "seam",
  },
];
