...
export const MUTATIONS = [
  ...
  },
  {
    ...
    file: HOUSE_BOT_VOCABULARY,
    from: "|chosen${HOUSE_JOIN}by${HOUSE_JOIN}(?:staff|you)",
    to: "",
    expect: "2.v · ruling 175 · CONTROL · every planted ",
    suite: "disclosure",
  },
  {
    ...
    file: HOUSE_BOT_VOCABULARY,
    from: "|including${HOUSE_JOIN}house\\\\b`;",
    to: "|including${HOUSE_JOIN}house`;",
