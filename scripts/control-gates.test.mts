...
// the implementation reads would make the test agree with any bug it contains.
{
  const EXPECT: Record<string, Partial<Record<ControlId, boolean>>> = {
    ...
    ADMIN:      { recheckMarketNow: true,  setTwoAdminAuth: true,  resolveMarket: true,  aiToolkit: true, purgeChainHistory: true,  emergencyVoidMarket: true,  voidUpDownRound: true , generateUpDownRound: true , createAsset: true, updateAsset: true, toggleAsset: true, updateReadingMethod: true, updateThresholds: true, armProposal: true, saveProposalsConfig: true, bulkResolveMarkets: true, bulkResolveOverride: true, approveProposal: true},
    ...
    MODERATOR:  { recheckMarketNow: false, setTwoAdminAuth: false, resolveMarket: true,  aiToolkit: false, purgeChainHistory: false, emergencyVoidMarket: false, voidUpDownRound: true , generateUpDownRound: true , createAsset: false, updateAsset: false, toggleAsset: false, updateReadingMethod: false, updateThresholds: false, armProposal: false, saveProposalsConfig: false, bulkResolveMarkets: true, bulkResolveOverride: false, approveProposal: false},
...
// drift silently — which is exactly how E-18 and E-19 happened.
{
  const SITES: Record<ControlId, string> = {
    ...
    purgeChainHistory: "src/app/admin/retention/purge-actions.ts",
  };
