...
async function player(id: string, balance: number) {
  ...
  await db.kyc.upsert({ id: `kyc_${id}`, userId: id, status: "APPROVED", rejectReason: null, rejectNote: null, idType: "NIDA", idNumber: "19900101456712341234", idExpiry: null, idVerifiedAt: now, fullName: "T", dob: "1990-01-01", documents: [], reviewerId: null, reviewedAt: null, submittedAt: now, createdAt: now, updatedAt: now } as never);
}
