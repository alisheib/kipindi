...
4. **Commit 2 (money seam) is 🟡** (started 2026-09-14, OMEGA-COMPILE01, unattended run on Ali's ruling).
   ...
   3. **Next, in order (half-done items first):**
      ...
      2. (h) A17 liquidity label line on per-bettor outcome notices (notification-service emitters listed in A17) — after the suites; scope check against commit 5's holder chip first.
