...
| **Last updated** | 2026-09-14 · OMEGA-COMPILE01 · `F:/kipindi-house-bots` (Commit 2 closed ✅; Commit 3 🟡, spec only) |
...
| 3 | Designation · eligibility · password verification (services) | 🟡 2026-09-14 · OMEGA-COMPILE01 | ⬜ | ⬜ | ⬜ | ⬜ | — | ⬜ | ⬜ | ⬜ | ⬜ |
...
- **Schema + 2 migrations:**
  - S1 migration law.
  - A23 migration rules: timestamped after the newest `main` migration (was `20260913120000_kyc_at_withdrawal`; since the 2026-09-14 merge `20260914120000_rg_pending_limits_play_clock`, step 7.8.2b), touching no KYC table; `IF NOT EXISTS` with fixed names; above 500k positions or 1M transactions, build the marker indexes `CONCURRENTLY` by hand first.
