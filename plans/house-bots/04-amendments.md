...
| 6 (~~public text~~) | P1 ⛔ **Superseded by D19 (Ali, 2026-09-16):** Commit 6 publishes no text; it keeps ~~the private Board draft~~ (struck 2026-09-20 by D21), the chatbot's forbidden-phrase guard, the docs of record and the non-disclosure suite. |
