...
| `OTP_ENABLED` | optional | `1` un-hides `/auth/otp`. ⚠️ No login/register UI links to it yet, so it does not by itself offer phone-code login. Leave unset until that UI ships. |
