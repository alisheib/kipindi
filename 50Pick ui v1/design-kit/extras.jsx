  ...
  <div className="specimen" style={{ width: 880 }}>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 6, marginBottom: 22 }}>
        {[0,1,2,3].map(i => (
          <div key={i} style={{ flex: 1, height: 4, borderRadius: 999, background: i === 0 ? 'var(--teal-400)' : 'var(--bg-overlay)' }} />
        ))}
      </div>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
        {['7','3','9','2','•','•'].map((d, i) => (
          <div key={i} style={{
            ...
            border: `1px solid ${i < 4 ? 'var(--teal-400)' : 'var(--border)'}`,
    ...
    <div style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border)', borderRadius: 'var(--r-lg)', overflow: 'hidden' }}>
      ...
      {[
        ...
        <div key={i} style={{
          ...
          <span className="mono" style={{ color: 'var(--teal-300)', fontSize: 12, display: 'flex', alignItems: 'center', gap: 4 }}>{src}<Icon name="external" size={12} /></span>
  ...
  return (
    <div className="specimen" style={{ width: 1280 }}>
      ...
      <svg viewBox="0 0 1200 1700" style={{ width: '100%', height: 'auto', background: 'var(--bg-elevated)', borderRadius: 'var(--r-lg)', border: '1px solid var(--border)' }}>
        ...
        {/* Top nav */}
        <g stroke="var(--teal-400)" strokeWidth="1.5" fill="none">
          <rect x="40" y="40" width="1120" height="56" rx="8" />
          <rect x="60" y="56" width="100" height="24" rx="4" />
          <text x="70" y="73" fill="var(--teal-300)" fontFamily="Sora" fontSize="14" fontWeight="700">[wordmark]</text>
        ...
        {/* Hero */}
        <g>
          <rect x="40" y="120" width="1120" height="420" rx="14" fill="none" stroke="var(--teal-400)" strokeWidth="1.5" strokeDasharray="6 6" />
          ...
          <text x="80" y="290" fill="var(--teal-400)" fontFamily="Sora" fontSize="48" fontWeight="700" letterSpacing="-1">Not chance.</text>
          ...
          {/* CTA */}
          <rect x="620" y="380" width="220" height="56" rx="10" fill="var(--teal-500)" />
        ...
        <g>
          <rect x="40" y="580" width="1120" height="280" rx="14" fill="none" stroke="var(--teal-400)" strokeWidth="1.5" strokeDasharray="6 6" />
        ...
        {/* How it works */}
        <g>
          <rect x="40" y="900" width="1120" height="200" rx="14" fill="none" stroke="var(--teal-400)" strokeWidth="1.5" strokeDasharray="6 6" />
          ...
          {[
            ...
            <g key={n} transform={`translate(${80 + i * 360}, 960)`}>
              <circle cx="32" cy="32" r="24" fill="none" stroke="var(--teal-400)" strokeWidth="1.5" />
              <text x="32" y="40" fill="var(--teal-300)" fontFamily="Sora" fontSize="22" fontWeight="700" textAnchor="middle">{n}</text>
        ...
        {/* Why us */}
        <g>
          <rect x="40" y="1140" width="1120" height="200" rx="14" fill="none" stroke="var(--teal-400)" strokeWidth="1.5" strokeDasharray="6 6" />
        ...
        {/* Leaderboard preview */}
        <g>
          <rect x="40" y="1380" width="540" height="220" rx="14" fill="none" stroke="var(--teal-400)" strokeWidth="1.5" strokeDasharray="6 6" />
        ...
        {/* Recent resolutions */}
        <g>
          <rect x="620" y="1380" width="540" height="220" rx="14" fill="none" stroke="var(--teal-400)" strokeWidth="1.5" strokeDasharray="6 6" />
    ...
    <div style={{ display: 'flex', gap: 12, alignItems: 'flex-end', marginBottom: 28, flexWrap: 'wrap' }}>
      {[['1',4],['2',8],['3',12],['4',16],['5',20],['6',24],['8',32],['10',40],['12',48],['16',64]].map(([t,n]) => (
        <div key={t} style={{ textAlign: 'center' }}>
          <div style={{ width: n, height: n, background: 'var(--teal-500)', borderRadius: 4, margin: '0 auto 6px' }} />
