  ...
  return (
    <div
      className={cn(
        ...
        interactive &&
          "transition-all duration-200 ease-out hover:-translate-y-[3px] hover:border-brand-500 hover:shadow-[var(--shadow-4),var(--glow-blue)] cursor-pointer active:translate-y-0 active:shadow-e2",
        className,
      )}
      {...props}
    />
