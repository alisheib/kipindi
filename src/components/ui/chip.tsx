...
const variantStyle: Record<Variant, React.CSSProperties> = {
  ...
  live:      { background: "color-mix(in oklab, var(--danger-500) 16%, transparent)",                                      color: "var(--live-400)",                    borderColor: "color-mix(in oklab, var(--danger-500) 28%, transparent)" },
  ...
  pending:   { background: "color-mix(in oklab, var(--info-500) 16%, transparent)",                                        color: "var(--info-fg)",                     borderColor: "color-mix(in oklab, var(--info-500) 28%, transparent)" },
  objection: { background: "color-mix(in oklab, var(--warning-500) 18%, transparent)",                                     color: "var(--warning-fg)",                  borderColor: "color-mix(in oklab, var(--warning-500) 30%, transparent)" },
