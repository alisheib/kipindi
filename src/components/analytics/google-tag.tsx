 ...
 *
 * This is Google's install snippet, with five things a plain paste gets wrong on this site:
 *
 ...
 * original arguments. ⛔ A body the guard cannot read synchronously (a Blob, FormData, a Request object) is
