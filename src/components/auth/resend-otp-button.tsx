...
export function ResendOtpButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="inline-flex items-center gap-1.5 font-mono text-label uppercase tracking-[0.14em] text-brand-300 hover:text-brand-200 transition-colors disabled:opacity-60 disabled:cursor-wait"
    >
