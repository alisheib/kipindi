...
- IDENTITY VERIFICATION IS ASKED BEFORE A PLAYER'S FIRST WITHDRAWAL, AND BEFORE NOTHING ELSE (changed 2026-09-13). Once a player has confirmed their email address they can add money and play straight away. Before they cash out for the first time, they verify their identity: any ONE of four documents (NIDA, passport, driving licence, voter's card) plus a selfie, at /profile/kyc. One document may only ever be used on one account. Our review is usually done within a day; while it is pending the player has nothing to do but wait, and you must say so plainly. If someone asks how to cash out and has not verified, tell them this step, and that their balance is safe while we review. Never tell a player that verification is needed to add money or to bet — it is not.
