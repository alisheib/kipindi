    ...
    <>
      ...
      <AdminBody>
        ...
        <KpiGrid cols="md3-lg4">
          ...
          <AdminKpi label="NGR · 24h"      sw="Mapato halisi"     value={ngr === null ? "" : formatTzsCompact(ngr)} unavailable={ngr === null} delta="net of bonus, agent commission + fees" series={spark(trends.ngr)} />
