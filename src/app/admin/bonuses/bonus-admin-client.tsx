  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-lg border border-border bg-bg-elevated p-4">
        <p className="font-mono text-micro uppercase eyebrow text-text-subtle mb-3">Defaults · platform-wide · Misingi</p>
      ...
      <div className="rounded-lg border border-border bg-bg-elevated p-4 space-y-3">
        <p className="font-mono text-micro uppercase eyebrow text-text-subtle">Bonus rules · Management policy · Sheria</p>
