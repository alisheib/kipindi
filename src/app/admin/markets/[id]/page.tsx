        ...
        <AdminCard padding="p-4">
          <div className="flex items-start gap-4">
            <div className="flex-1 min-w-0">
              ...
              {m.titleSw && <p className="mt-0.5 text-body-sm italic text-text-subtle">{m.titleSw}</p>}
              {m.titleZh && <p className="mt-0.5 text-body-sm italic text-text-subtle">{m.titleZh}</p>}
          ...
          <form className="flex flex-wrap items-center gap-2">
            <div className="relative flex-1 min-w-0 sm:min-w-[220px]">
              ...
              <input
                ...
                className="w-full h-[var(--h-control-xs)] pl-9 pr-3 rounded-md bg-bg-inset border border-border text-text font-mono text-body-sm focus:outline-none admin-focus transition-colors"
              />
            </div>
