...
export function BalanceAdjustControls({
  ...
  return (
    <>
      ...
      >
        <p className="font-mono text-micro uppercase eyebrow font-bold text-text mb-1">Balance adjustment · Marekebisho</p>
        ...
        {stage1Msg && (
          <p className="mt-3 rounded-md border border-border bg-bg-sunken/40 px-3 py-2 text-body-sm text-text-secondary" role="status">
            <span className="font-mono text-micro uppercase eyebrow font-bold text-text block mb-0.5">Awaiting second officer</span>
            {stage1Msg}
          </p>
        )}
