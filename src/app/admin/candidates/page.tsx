      ...
      <AdminBody>
        ...
        {approvedSorted.length > 0 && (
          <AdminCard padding="p-0">
            ...
            <CardSortControl
              basePath="/admin/candidates"
              railId="candidate-sort-approved"
              prefix="a"
              current={a.sort}
              dir={a.dir}
              sp={sp}
...
/* ⛔ `CardSortControl` USED TO LIVE HERE, byte-identical to the copy in
   `admin/ai-polls/page.tsx` apart from the one line naming the route. Both are gone: it is
   `src/components/admin/card-sort-control.tsx` now, taking a `basePath`, converted once to the
   kit `FilterPill` (DG-A-06, 2026-08-30). See that file's header for why an empty queue is not
   evidence. */
