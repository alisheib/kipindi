...
export async function POST() {
  ...
  try {
    ...
    await onRecruitSettlement(recruit.id, { operatorNetFee: 3_000, marketId: "mkt_devtest", positionId: `pos_${crypto.randomUUID()}`, houseBotId: null });
    ...
    await onRecruitSettlement(pausedRecruit.id, { operatorNetFee: 3_000, marketId: "mkt_devtest", positionId: `pos_${crypto.randomUUID()}`, houseBotId: null });
