...
export const dict = {
  ...
  en: {
    common: {
      ...
      fairnessIntro: "Every market on 50pick is resolved by a compliance officer against a public source URL. The audit chain captures the signature, the source, and the recorded outcome. When two-admin authorization is enabled, a second, distinct officer must countersign. A public objection window of {hours} hour(s) opens after resolution, and no money moves until it closes. If you spot something wrong, flag the market \u2014 the audit trail catches every flag.",
      ...
      fairnessStage2Body: "When two-admin authorization is on, a different officer independently confirms and audit logs the second signature. The objection window of {hours} hour(s) opens after resolution.",
    ...
    help: {
      ...
      faq7a: "Bets on voided markets have their stakes refunded to your wallet. Settlement corrections by the source authority within {hours} hour(s) of resolution are honoured \u2014 see Terms \u00a76.",
  ...
  sw: {
    common: {
      ...
      fairnessIntro: "Kila soko kwenye 50pick linatatuliwa na afisa wa ufuatiliaji dhidi ya chanzo rasmi cha URL. Kumbukumbu inashika saini, chanzo na matokeo yaliyorekodiwa. Idhini ya maafisa wawili ikiwashwa, afisa tofauti wa pili lazima athibitishe. Dirisha la pingamizi la saa {hours} linafunguliwa baada ya utatuzi, na hakuna fedha inayohamishwa hadi lifungwe.",
      ...
      fairnessStage2Body: "Idhini ya maafisa wawili ikiwashwa, afisa tofauti anathibitisha na kumbukumbu inaandika saini ya pili. Dirisha la pingamizi la saa {hours} linafunguliwa baada ya utatuzi.",
    ...
    help: {
      ...
      faq7a: "Madau kwenye masoko yaliyobatilishwa yanarejeshwa kwenye pochi yako. Masahihisho ya utatuzi ndani ya saa {hours} yanazingatiwa \u2014 tazama Masharti \u00a76.",
  ...
  zh: {
    common: {
      ...
      fairnessIntro: "50pick上的每个市场都由一名合规人员根据公开来源URL进行结算。审计链记录签名、来源和记录的结果。启用双重授权时，须由另一名不同的人员会签。结算后开放 {hours} 小时的公开异议窗口，窗口关闭前不会有任何资金转移。如果您发现问题，请标记市场 \u2014 审计记录会捕捉每个标记。",
      ...
      fairnessStage2Body: "启用双重授权时，另一名人员独立确认，审计日志记录第二个签名。结算后开放 {hours} 小时的异议窗口。",
    ...
    help: {
      ...
      faq7q: "\u5982\u679c\u5e02\u573a\u4f5c\u5e9f\u600e\u4e48\u529e\uff1f",
      faq7a: "\u4f5c\u5e9f\u5e02\u573a\u7684\u6295\u6ce8\u5c06\u9000\u8fd8\u5230\u60a8\u7684\u94b1\u5305\u3002{hours}\u5c0f\u65f6\u5185\u7684\u7ed3\u7b97\u4fee\u6b63\u5c06\u88ab\u5c0a\u91cd \u2014 \u89c1\u6761\u6b3e\u00a76\u3002",
      faq8q: "\u5e73\u53f0\u516c\u5e73\u5417\uff1f",
